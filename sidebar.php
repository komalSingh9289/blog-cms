            ...
            <ul id="sidebarnav" class="pt-4">
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="add-user.php" class="sidebar-link"
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Post Management </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                  ...
                  <li class="sidebar-item">
                    <a href="posts.php" class="sidebar-link"
                      ><i class="mdi mdi-edit"></i
                      ><span class="hide-menu">View Post</span></a
                    >
                  </li>
                </ul>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Comments</span></a
                >
              </li>
